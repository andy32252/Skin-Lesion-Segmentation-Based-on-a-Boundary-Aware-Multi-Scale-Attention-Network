...
from .mix_transformer_with_glr import mix_transformer_encoders2 as mix_transformer_with_gram2_encoders
# from .mix_transformer_3 import mix_transformer_encoders as mix_transformer_3_encoders
...
encoders = {}
encoders.update(mix_transformer_with_gram2_encoders)
# encoders.update(mix_transformer_3_encoders)
